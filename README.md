...
- `blender/pokepia-town-with-residents.blend` contains the full scene and all six animated characters.
- `blender/player.blend` contains the standalone protagonist rig.
