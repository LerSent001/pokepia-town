...
for name,material in M.items():
 ...
 image=bpy.data.images.load(str(ROOT/f'public/textures/{texname}-paint.png'),check_existing=True);image.pack();image.filepath=f'//../public/textures/{texname}-paint.png'
